...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      ...
      <div className="pointer-events-none absolute left-1/2 top-[12%] h-[480px] w-[640px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent/[0.04] blur-[100px]" />
      ...
      <div className="relative z-10 mx-auto max-w-3xl space-y-6">
        <div className="relative mx-auto w-fit">
          ...
          <div className="absolute inset-0 scale-150 rounded-full bg-accent/[0.06] blur-3xl" />
          <Image
            src="/logo-hero.png"
            alt="Deepmint"
            width={400}
